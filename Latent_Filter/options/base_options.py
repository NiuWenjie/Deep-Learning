...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--latent_dim', default=10, type=int, help='the number of latent dim')
        parser.add_argument('--N', default=24, type=int, help='the number of feature map')
